...
class HeadlessSimulationTests(unittest.TestCase):
    ...
    def test_compact_full_replay_has_turnover_species_and_surfaces(self) -> None:
        ...
        self.assertIn("signal_field_stats_at_end", result.summary)
        self.assertIn("signal_end", result.summary)
        ...
        self.assertIn("signal_fields", result.viewer["analytics"])
        self.assertIn("signal_flow", result.viewer["analytics"])
